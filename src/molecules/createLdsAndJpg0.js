...
export default function createLdsAndJpg0(positions) {
    return new Promise((resolve, reject) => {
        ...
        //                                         break;
        //                                     default:
        //                                         callback(new GedError("104", `Erreur fichier non supporté ${type}`, document.archiveSource, document.archiveSource, "", document.codeEdi, 3, true));
        //                                         return;
        //                                 }
        //                             }).catch(err => {
        //                                 callback(new GedError("103", `Erreur lors du test de type de fichier`, document.fileName, document.archiveSource, err, document.codeEdi, 3, true));
        //                             });
        //                         }
        //                     });
        //                 });
